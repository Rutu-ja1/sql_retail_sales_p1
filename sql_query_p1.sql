...
SECLECT DISTINCT category FROM reatail_sales
...
--Q.7. write a SQL query to calculate the avrage sale for each month. Find out best selling month in each year
SELECT
year,
month,
avg_sale
...
--Q.9. write a SQL query to find the number of unique customer who purchesed items from each category
...
--Q.10. write a SQL query to create each shift and number of orders (Example Morinig <=12, Afternoon Between 12 & 17, Evening > 17)
WITH hourly_sale
AS
(
SELECT *,
